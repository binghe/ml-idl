...
type ('a,'b) token
type svalue
val KW_handle_t:  'a * 'a -> (svalue,'a) token
val KW_switch_is:  'a * 'a -> (svalue,'a) token
val KW_switch_type:  'a * 'a -> (svalue,'a) token
val KW_handle:  'a * 'a -> (svalue,'a) token
val KW_transmit_as:  'a * 'a -> (svalue,'a) token
val KW_max_is:  'a * 'a -> (svalue,'a) token
val KW_min_is:  'a * 'a -> (svalue,'a) token
val KW_length_is:  'a * 'a -> (svalue,'a) token
val KW_last_is:  'a * 'a -> (svalue,'a) token
val KW_first_is:  'a * 'a -> (svalue,'a) token
val KW_context_handle:  'a * 'a -> (svalue,'a) token
val KW_ignore:  'a * 'a -> (svalue,'a) token
val KW_reflect_deletions:  'a * 'a -> (svalue,'a) token
val KW_maybe:  'a * 'a -> (svalue,'a) token
val KW_broadcast:  'a * 'a -> (svalue,'a) token
val KW_idempotent:  'a * 'a -> (svalue,'a) token
val KW_ISO_UCS:  'a * 'a -> (svalue,'a) token
val KW_ISO_MULTILINGUAL:  'a * 'a -> (svalue,'a) token
val KW_ISO_LATIN1:  'a * 'a -> (svalue,'a) token
val KW_error_status_t:  'a * 'a -> (svalue,'a) token
...
val KW_wchar_t:  'a * 'a -> (svalue,'a) token
...
val KW_import:  'a * 'a -> (svalue,'a) token
